...
# --- SQL Helper and Parser Utilities (formerly in db_compat.py) ---
    ...
    def execute(self, query: str, params: tuple = ()):
        ...
        while True:
            ...
            try:
                ...
                # Rollback current PG transaction on failure
                try:
                    self.conn.rollback()
                except Exception:
                    pass
...
# --- Singleton instance and exports for backward compatibility ---
