"""database optimization - client_history table and triggers

Revision ID: 0032_client_history
Revises: 0031_updated_at_triggers
...
def upgrade() -> None:
    ...
    # 2. Trigger functions and triggers for client history auto-sync
    op.execute("""
...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS idx_ch_date")
    op.execute("DROP INDEX IF EXISTS idx_ch_client_id")
